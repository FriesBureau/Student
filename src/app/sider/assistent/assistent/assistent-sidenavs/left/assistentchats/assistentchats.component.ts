...
import { FuseMatSidenavHelperService } from '../../../../../../directives/fuse-mat-sidenav.service';
import { ChattestService } from '../../../../../../services/chattest.service';

import { AssistentService } from '../../../../../../services/assistent.service';

@Component({
    selector     : 'assistent-chats-sidenav',
    templateUrl  : './assistentchats.component.html',
    styleUrls    : ['./assistentchats.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations   : fuseAnimations
})
export class AssistentChatsSidenavComponent implements OnInit, OnDestroy
{
    chats: any[];
    chatSearch: any;
    contacts: any[];
