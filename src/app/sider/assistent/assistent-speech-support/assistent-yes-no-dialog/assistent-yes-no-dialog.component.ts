...
import { AssistentYesNo } from './assistent-yes-no.enum';
...
export class AssistentYesNoDialogComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<AssistentYesNoDialogComponent>,
